  ...
  return (
    ...
    >
      ...
      <ul className="flex space-x-6 text-sm font-extrabold text-gray-500">
        ...
        <li><Link to="/flights" className="hover:text-yellow-300">Flights</Link></li>
        <li><Link to="/promo" className="hover:text-yellow-300">Promo</Link></li>
      </ul>

      <div className="flex items-center space-x-2 text-gray-800 font-semibold">
        <Link to="/profileemoney" className="flex items-center space-x-2 hover:text-yellow-300">
