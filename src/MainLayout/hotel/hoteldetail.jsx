      ...
      <div className="w-full max-w-[1150px] bg-[#F7FDFF] rounded-2xl p-12 mt-20">
        ...
        <section className="mt-16">
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, #A8DBFB 70%, #D9E3E9 100%)",
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 space-y-4 text-gray-800">
                ...
                <div>
                  ...
                  <div
                    className="flex items-center gap-6 text-[16px] italic font-medium"
                    style={{ fontFamily: "Poppins" }}
                  >
                    <p>📏 25.7 m²</p>
                    <p>👤 2 Guest</p>
                ...
                <div>
                  ...
                  <div
                    className="grid grid-cols-2 md:grid-cols-3 gap-2 text-[16px] italic font-medium"
                    style={{ fontFamily: "Poppins" }}
                  >
                    <p>● AC</p>
                ...
                <div>
                  ...
                  >
                    ...
                    designed for discerning travelers. With floor-to-ceiling
                    windows offering a glimpse of the bustling city skyline,
                    this room is tailored for both business and leisure stays.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 space-y-1 text-center md:text-left">
                ...
                <p className="text-xs text-gray-500">
                  Provided by travelers on Sky Book
                </p>
              </div>
