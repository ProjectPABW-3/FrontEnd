  ...
  return (
    <div className="bg-[#F8F8F8] px-6 min-h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-[1150px] bg-[#F7FDFF] rounded-2xl p-12 mt-20">
        ...
        <div id="kamar" className="w-full bg-[#00B6DE] flex items-center justify-center gap-4 rounded-xl py-2 px-2 mb-6 mt-60">
          {/* Logo Sky Book */}
          <img
          ...
          <section className="mt-16">
            ...
            <div id="fasilitas" className="w-full bg-[#00B6DE] flex items-center justify-center gap-4 rounded-xl py-2 px-2 mb-6 mt-60">
                {/* Logo Sky Book */}
                <img
                  src="/images/skybook-logo.png" 
                  alt="Sky Book Logo"
              ...
              {/* Things To Do */}
                ...
                {/* Nearby Facilities */}
                  ...
                  <div id="review" className="w-full bg-[#00B6DE] flex items-center justify-center gap-4 rounded-xl py-2 px-2 mb-6 mt-28">
                    {/* Logo Sky Book */}
                    <img
                      src="/images/skybook-logo.png" 
                      alt="Sky Book Logo"
